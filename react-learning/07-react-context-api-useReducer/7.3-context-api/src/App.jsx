...
export default function App() {
  ...
  return (
    // Step 6: Adding required value prop to context component. e.g., <CartContext value={{items: []}}>
    // Step 7: Linking the state to the context via this 'value' prop to make context value dynamic e.g., <CartContext value={shoppingCart}>
    // Step 8: Adding updation func reference to context value object as property
    // Step 9: Add this func reference in default context object too for better auto-completion.
    // Step 9: Update the Product component accordingly for using addItemToCart in context object.
